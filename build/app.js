...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FetchingInfo = __webpack_require__(173);

	var _FetchingInfo2 = _interopRequireDefault(_FetchingInfo);

	var _Leaderboards = __webpack_require__(174);
	...
	var Layout = function (_React$Component) {
	    ...
	    _createClass(Layout, [{
	        ...
	        key: 'changeSorting',
	        value: function changeSorting(newSorting) {
	            this.setState({
	                sortedBy: newSorting
	            });
	        }
	        ...
	        value: function render() {
	            if (this.state.error) return _react2.default.createElement(_Error2.default, null);else if (this.state.fetching) return _react2.default.createElement(_FetchingInfo2.default, null);else return _react2.default.createElement(_Leaderboards2.default, { data: this.state.leaderboards, sortedBy: this.state.sortedBy, changeSorting: this.changeSorting.bind(this) });
	        }
	    }]);
	...
	var API = function () {
	    ...
	    _createClass(API, [{
	        ...
	        value: function fetchData() {
	            return Promise.all([this.fetchJSON(config.recentURL), this.fetchJSON(config.allTimeURL)]);
	        }
	    }, {
	        key: 'fetchJSON',
	        value: function fetchJSON(url) {
	            return new Promise(function (resolve, reject) {
	                _superagent2.default.get(url, function (err, response) {
	                    if (err || response.error) return reject(response.error);
...
/***/ function(module, exports) {
	...
	module.exports = {
	    recentURL: 'http://fcctop100.herokuapp.com/api/fccusers/top/recent',
	    allTimeURL: 'http://fcctop100.herokuapp.com/api/fccusers/top/alltime'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FetchingInfo = function (_React$Component) {
	    _inherits(FetchingInfo, _React$Component);

	    function FetchingInfo() {
	        _classCallCheck(this, FetchingInfo);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FetchingInfo).apply(this, arguments));
	    }

	    _createClass(FetchingInfo, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Leaderboards = function (_React$Component) {
	    ...
	    function Leaderboards() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Leaderboards).apply(this, arguments));
	    }
	    ...
	    _createClass(Leaderboards, [{
	        ...
	        key: 'sortInfo',
	        value: function sortInfo(sortType) {
	        ...
	        value: function render() {
	            ...
	            if (this.props.sortedBy === 'alltime') users = this.props.data[1];

	            var usersElemList = [];
	            users.forEach(function (user, i) {
	                usersElemList.push(_react2.default.createElement(_User2.default, { user: user, id: i + 1, key: i }));
	            });

	            return _react2.default.createElement(
	                'div',
	                { className: 'col-xs-12 table-responsive' },
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'th',
	                                { className: 'col-md-2', onClick: this.changeSorting.bind(this, 'recent') },
	                                'Recent' + this.sortInfo.call(this, 'recent')
	                            ),
	                            _react2.default.createElement(
	                                'th',
	                                { className: 'col-md-2', onClick: this.changeSorting.bind(this, 'alltime') },
	                                'All time',
	                                this.sortInfo.call(this, 'alltime')
	                            )
	                        )
	                    ),
	                    _react2.default.createElement(
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "td",
	                    { className: "col-md-7" },
	                    _react2.default.createElement("img", { src: userData.img, alt: userData.username, className: "img-fluid img-rounded m-r-1 pull-xs-left user-image" }),
	                    " ",
	                    userData.username
	                ),
	                _react2.default.createElement(
